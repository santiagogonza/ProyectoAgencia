...
public class TransporteModel {
	...
	public Transporte obtenerTransporte(List<Transporte> lista, long id) {
		for (Transporte transporte : lista) {
			//hace la comparación de de ide trasnporte si es igual al id entonces retorna el objeto transporte 
	...
	// aqui llamamos a los métodos de la clase transporte y esos métodos lo imprimos en pantalla
